...
_CREATE_TABLE_SQL = (
    ...
    "space_code_list VARCHAR(4096) NOT NULL DEFAULT '[]', "
    "team_space_code_list VARCHAR(4096) NOT NULL DEFAULT '[]', "
    "psnl_space_code_id VARCHAR(255) NOT NULL DEFAULT '', "
    "psnl_category_id_list VARCHAR(4096) NOT NULL DEFAULT '[]', "
    "customized_tag_list VARCHAR(4096) NOT NULL DEFAULT '[]', "
    "text_top_n INTEGER, "
